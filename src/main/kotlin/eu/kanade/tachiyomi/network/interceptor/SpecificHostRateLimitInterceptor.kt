...
) = addInterceptor(RateLimitInterceptor(httpUrl.host, permits * getRateLimitMultiplier(), period.toDuration(unit.toDurationUnit())))
...
): OkHttpClient.Builder = addInterceptor(RateLimitInterceptor(httpUrl.host, permits * getRateLimitMultiplier(), period))
...
fun OkHttpClient.Builder.rateLimitHost(
    ...
    permits: Int,
    period: Duration = 1.seconds,
): OkHttpClient.Builder = addInterceptor(RateLimitInterceptor(url.toHttpUrlOrNull()?.host, permits * getRateLimitMultiplier(), period))
